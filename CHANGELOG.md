...
First public release. A deterministic security runtime for AI agents that sits
inline on every tool call and MCP message. **206 tests, 1 skipped.** Security
benchmark: **0% attack-success rate / 100% utility / ~0.04 ms per call**; real
AgentDojo (97 user + 35 injection tasks): **0% ASR / 100% utility** under
deterministic ground-truth replay. Every OWASP ASI-2026 risk has a shipped
mechanism.
...
[0.1.0]: https://github.com/harsha-mangena/capguard/releases/tag/v0.1.0
